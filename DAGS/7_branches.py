...
#         api_extracted_data = ti.xcom_pull(taskids='extract_task')['api_extracted_data']
#         print('Transforming API Data:{api_extracted_data}....')
#         transformed_s3_data=[i*10 for i in api_extracted_data]
...
#         api_extracted_data = ti.xcom_pull(taskids='extract_task')['api_extracted_data']
#         print('Transforming API Data:{api_extracted_data}....')
#         transformed_db_data=[i*100 for i in api_extracted_data]
#         ti.xcom_push(key='return_value',value=transformed_db_data)
...
#         api_extracted_data = ti.xcom_pull(taskids='extract_task')['api_extracted_data']
#         print('Transforming API Data:{api_extracted_data}....')
#         transformed_s3_data=[i*1000 for i in api_extracted_data]
#         ti.xcom_push(key='return_value',value=transformed_s3_data)
...
#         api_data=kwargs['ti'].xcom_pull(taskids='transform_task_api')
#         db_data=kwargs['ti'].xcom_pull(taskids='transform_task_db')
#         s3_data=kwargs['ti'].xcom_pull(taskids='transform_task_s3')

#         return f" echo 'Loaded_data: {api_data}, {db_data}, {s3_data}'"
